#!/usr/bin/env bash
# planted-window control: 4 cm2 of the w043 render spliced into PHerc0813/z6496_w040 (median-S1 mesh in pscamillo maps), then the identical recipe
cd /workspace/atlas/planted; W=/workspace/atlas; PY=$W/villa/vesuvius/.venv/bin/python; CK=$W/checkpoints
T=$(ls -d $W/renders/PHerc0813/z6496_w040/surface-volumes/*.zarr | head -1)
